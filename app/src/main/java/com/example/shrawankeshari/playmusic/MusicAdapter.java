    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = ((Activity) getContext()).getLayoutInflater()
                    .inflate(R.layout.item_list_offline, parent, false);
        }

        ImageView im = convertView.findViewById(R.id.list_image_offline);
        TextView tv_title = convertView.findViewById(R.id.list_title_offline);
        TextView tv_artist = convertView.findViewById(R.id.list_artist_offline);
        TextView tv_duration = convertView.findViewById(R.id.list_duration_offline);
